...
Avant de commencer, s'assurer d'avoir fait la [préparation de l'environnement de développement](/getting-started/customize-psdk/preparer-son-environnement), qui installe **Git** et **VS Code**. La plupart des étapes ci-dessous se font graphiquement dans VS Code et sur le site GitHub ou GitLab. Pour le vocabulaire Git utilisé ici (**commit**, **branche**, **remote**) et la clé SSH optionnelle, voir [Découvrir Git](/getting-started/decouvrir-git). On recommande aussi d'installer l'extension **GitLens** (voir [GitLens](/getting-started/customize-psdk/preparer-son-environnement#gitlens-optionnel)).
