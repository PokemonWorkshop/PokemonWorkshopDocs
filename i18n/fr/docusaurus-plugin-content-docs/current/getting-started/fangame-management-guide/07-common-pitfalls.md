...
Toutes les personnes qui créent un fangame font des erreurs.
C'est normal.

La plupart d'entre elles ne viennent ni d'un manque de talent, ni d'un manque de motivation. Elles viennent simplement du fait que l'on découvre un métier complexe en le pratiquant.

Au fil des années, nous avons vu revenir les mêmes situations sur de nombreux projets Pokémon. Si vous vous reconnaissez dans certaines d'entre elles, rassurez-vous : vous n'êtes ni le premier, ni le dernier.

L'important n'est pas d'éviter toutes les erreurs.
L'important est de les reconnaître suffisamment tôt pour pouvoir ajuster votre façon de travailler.

## Vouloir tout créer avant de commencer le jeu

C'est probablement l'un des pièges les plus fréquents dans les fangames Pokémon.

Créer des ressources est particulièrement motivant.

On imagine de nouveaux Pokémon.
On dessine leurs sprites.
On crée des objets, des capacités, des personnages, des interfaces…
Petit à petit, le projet accumule énormément de contenu.

Pourtant, plusieurs mois plus tard, il est parfois impossible de jouer plus de cinq minutes.
...
Au début d'un projet, tout paraît possible.

9 régions.
Des centaines de Fakemon.
Toutes les générations de Pokémon.
Des dizaines de villes.
Un scénario de cinquante heures.
...
Plus vous développerez votre fangame, plus vous progresserez.

Vos cartes seront meilleures.
Votre scénario sera plus cohérent.
Votre code sera plus propre.
Vous aurez donc naturellement envie de reprendre vos anciens travaux.
...
Il est facile de repousser une décision.
...
Un nouvel éditeur sort.

Une nouvelle technologie devient populaire.
Un autre fangame utilise une solution différente.

La tentation est grande de repartir sur de nouvelles bases.

Pourtant, chaque migration demande :
...
Mais chacun d'eux représente un projet à part entière.
...
Les réseaux sociaux montrent surtout les réussites.

Les belles captures d'écran.
...
La motivation est précieuse mais elle fluctue.

Certaines semaines, vous aurez envie de développer pendant des heures.
D'autres, vous n'ouvrirez même pas votre projet.
...
Publier une première démo est une étape importante.
Mais c'est aussi le début d'une nouvelle phase.

Les joueurs découvriront :
...
La différence réside souvent dans leur capacité à reconnaître rapidement ces situations et à adapter leur manière de travailler.
