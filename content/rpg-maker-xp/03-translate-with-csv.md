...
Run it from the project folder, with the project **uncompiled** so the source is available (see [Set up the development environment](/getting-started/customize-psdk/setup-development-environment)):
