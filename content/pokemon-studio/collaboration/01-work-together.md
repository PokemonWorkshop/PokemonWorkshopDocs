...
Keep the page open: it shows the repository **URL** you will need later. If you signed in to VS Code, copy the **HTTPS** URL; if you set up an SSH key (see [Discover Git](/misc/discover-git#setting-up-ssh)), copy the **SSH** URL (it starts with `git@`).
